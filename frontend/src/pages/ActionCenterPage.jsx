...
const INITIAL_ACTIONS = [
  {
    ...
    financialImpact: '$18,500 tooling preserved',
  ...
  },
  {
    ...
    xaiSteps: [
      ...
      { step: 3, label: 'Supply Chain Cascade', text: 'Apex Industrial lead time was 14 days ($38,500 downtime cost). Agent cascaded to MotionPro Solutions (1-day lead time).' },
      { step: 4, label: 'Financial Audit', text: 'Total PO commitment: $1,420.00 USD. Net projected downtime avoidance savings: $37,080.00.' },
    ...
    financialImpact: '$37,080 downtime saved · $1,420 PO commitment',
    primaryActionLabel: 'Authorize Purchase Order ($1,420)',
  ...
  },
  {
    ...
    xaiSteps: [
      ...
      { step: 3, label: 'Reliability Queue Prohibition', text: 'Under plant policy, queueing emergency stoppage is disallowed (incurs $1,200/hr idle line cost).' },
    ...
    financialImpact: 'Prevents 3.2h idle line queue ($3,840 loss)',
  ...
  },
  {
    ...
    financialImpact: 'Eliminates repetitive $2,400 monthly band-aid repairs',
  ...
  },
  {
    ...
    summary: 'Wrist thermal gradient rose at 1.8°C/hr. Agent throttled traverse velocity to 85%, arresting temperature at 62°C while sustaining $1,377/hr production yield.',
    xaiSteps: [
      ...
      { step: 3, label: 'Yield Preservation', text: 'Preserves continuous production ($1,377/hr gross) rather than incurring zero-yield thermal lockout.' },
    ],
    financialImpact: '$1,377/hr yield maintained vs $0 shutdown',
